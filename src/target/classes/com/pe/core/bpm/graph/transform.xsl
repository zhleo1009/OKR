...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	xmlns:calc="xalan://com.pe.core.bpm.graph.TransformUtil" 
	...
	<xsl:template match="bg:SubProcess">
		<xsl:for-each select=".">
			<subProcess>
				...
				<extensionElements>
					<!-- 流程开始事件监听器 -->
					<activiti:executionListener class="com.hotent.platform.service.bpm.listener.SubProcessStartListener" event="start" />
					<!-- 流程结束事件监听器 -->
					<activiti:executionListener class="com.hotent.platform.service.bpm.listener.SubProcessEndListener" event="end" />
				</extensionElements>
			...
			<xsl:choose>
				<xsl:when test="@user='true'">
					<userTask>
						...
						<extensionElements>
							<activiti:taskListener event="create" class="com.hotent.platform.service.bpm.listener.TaskCreateListener" />
							<activiti:taskListener event="assignment" class="com.hotent.platform.service.bpm.listener.TaskAssignListener" />
							<activiti:taskListener event="complete" class="com.hotent.platform.service.bpm.listener.TaskCompleteListener" />
				...
				<xsl:when test="@script='true'">
					<serviceTask activiti:class="com.hotent.platform.service.bpm.ScriptTask">
						<xsl:call-template name="setAttrubute">
							<xsl:with-param name="obj" select="."></xsl:with-param>
						</xsl:call-template>
						<extensionElements>
				...
				<xsl:when test="@mail='true'">
					<serviceTask activiti:class="com.hotent.platform.service.bpm.MessageTask">
						<xsl:call-template name="setAttrubute">
							<xsl:with-param name="obj" select="."></xsl:with-param>
						</xsl:call-template>
						<extensionElements>
				...
				<xsl:when test="@webService='true'">
					<serviceTask activiti:class="com.hotent.platform.service.bpm.WebServiceTask">
						<xsl:call-template name="setAttrubute">
							<xsl:with-param name="obj" select="."></xsl:with-param>
						</xsl:call-template>
						<extensionElements>
				...
				<xsl:when test="@multiInstance='true'">
					<userTask>
						...
						<extensionElements>
							<activiti:taskListener event="create" class="com.hotent.platform.service.bpm.listener.TaskSignCreateListener" />
							<activiti:taskListener event="assignment" class="com.hotent.platform.service.bpm.listener.TaskAssignListener" />
							<activiti:taskListener event="complete" class="com.hotent.platform.service.bpm.listener.TaskCompleteListener" />
							<xsl:call-template name="setTaskExtProperties">
								<xsl:with-param name="obj" select="."></xsl:with-param>
				...
				<xsl:when test="@startSubFlow='true'">
					<callActivity>
						...
						<extensionElements>
							<activiti:executionListener event="start" class="com.hotent.platform.service.bpm.listener.CallSubProcessStartListener"></activiti:executionListener>
							<activiti:executionListener event="end" class="com.hotent.platform.service.bpm.listener.CallSubProcessEndListener"></activiti:executionListener>
