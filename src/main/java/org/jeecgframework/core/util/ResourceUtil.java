...
public class ResourceUtil {
	...
	//完成通过状态
		public static final int FINISH_STATUS_WRITE  = 0;
		public static final int FINISH_STATUS_EXAMINE   = 3;
		public static final int FINISH_STATUS_PASS  = 1;
		public static final int FINISH_STATUS_NOPASS  = 2;
	
	
	
	//删除状态1：表示存在
	public static final int DELETE_STATUS_EXITS  = 1;
	
	//删除状态  0:表示删除
	public static final int DELETE_STATUS_DEL  = 0;
	
	//设备状态Condit 	
	/**
	 * 申请中
	 */
	public static final int Condit_APPLY  = 0;
	/**
	 * 合格
	 */
	public static final int Condit_STANDARD  = 1;
	
	/**
	 * 领用
	 */
	public static final int Condit_USE  = 2;
	/**
	 * 借出
	 */
	public static final int Condit_BORROW  = 3;
	/**
	 * 报废
	 */
	public static final int Condit_SCRAP  = 4;
	/**
	 * 停用
	 */
	public static final int Condit_STOPUSE  = 5;
	/**
	 * 维修
	 */
	public static final int Condit_REPAIR  = 6;
	/**
	 * 无实物
	 */
	public static final int Condit_NOTHING  = 7;
	/**
	 * 验收中
	 */
	public static final int Condit_CHECKING  = 8;
	/**
	 * 封存
	 */
	public static final int Condit_SEALED  = 9;
	/**
	 * 启用
     */
	public static final int Condit_ENABLEUSE  = 10;
