...
public class SysThemesUtil {
	...
	public static String getEasyUiTheme(SysThemesEnum sysThemesEnum){
		...
		if("lte".equals(sysThemesEnum.getThemes())){
			sb.append("<link id=\"easyuiTheme\" rel=\"stylesheet\" href=\"plug-in/easyui_1.4.4/themes/bootstrap/easyui.css\" type=\"text/css\"></link>");
		}else{
	...
	public static String getEasyUiIconTheme(SysThemesEnum sysThemesEnum){
		StringBuffer sb = new StringBuffer("");
		if("metrole".equals(sysThemesEnum.getThemes()) || "lte".equals(sysThemesEnum.getThemes())){//add by zbk
	...
	public static String getLhgdialogTheme(SysThemesEnum sysThemesEnum){
		...
		}else if("lte".equals(sysThemesEnum.getThemes())){
			sb.append("<script type=\"text/javascript\" src=\"plug-in/lhgDialog/lhgdialog.min.js?skin=idialog\"></script>");
		}else{
	...
	public static String getBootstrapTabTheme(SysThemesEnum sysThemesEnum){
		...
		if("metro".equals(sysThemesEnum.getThemes())){
			...
			sb.append("<script type=\"text/javascript\" src=\"plug-in/ace/js/bootstrap-tab.js\"></script>");
		}else if("lte".equals(sysThemesEnum.getThemes())){//add by zbk
			sb.append("<script type=\"text/javascript\" src=\"plug-in/lte/bootstrap/js/bootstrap-tab.js\"></script>");
		}
		return sb.toString();
	}
	...
	public static String getValidformStyleTheme(SysThemesEnum sysThemesEnum){
		...
		}else if("metrole".equals(sysThemesEnum.getThemes()) || "lte".equals(sysThemesEnum.getThemes())){
