...
public class CommonServiceImpl implements CommonService {
	...
	public List<ComboTree> ComboTree(List all, ComboTreeModel comboTreeModel, List in, boolean recursive, boolean isOpen) {
        return commonDao.ComboTree(all, comboTreeModel, in, recursive, isOpen);
	}
	...
	public <T> List<T> findByHql(String hql, Map<String, Object> map, int pageSize, int pageNo){
		 return this.commonDao.findByHql(hql, map, pageSize, pageNo);
	}
	...
	public <T> T findUniqueByPropertyMap(Class<T> entityClass,
		...
		return commonDao.findUniqueByPropertyMap(entityClass, map);
	}
