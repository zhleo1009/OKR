...
enum RandCodeImageEnum {
	 ...
	 * 混合字符串
	 */
	ALL_CHAR("23456789abcdefghjkmnpqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ"), // 去除数字0和oil的大小写
	/**
	 * 字符
	 */
	LETTER_CHAR("abcdefghjkmnpqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ"),
	/**
	 * 小写字母
	 */
