...
public class TuiSongMsgUtil {
	...
	/**
	  ...
	  * @throws
	 */
	public static TSSmsEntity sendMessage(String title,String msgType, String code,
			Map<String, Object> map, String sentToUesrId, String sentToUserName, String senderUserName) throws Exception{
		try {
			TSSmsEntity tss=new TSSmsEntity();
			tss.setEsType(msgType);
			tss.setEsTitle(title);
			tss.setEsReceiverUserId(sentToUesrId);
			tss.setEsReceiver(sentToUserName);
			tss.setEsSender(senderUserName);
