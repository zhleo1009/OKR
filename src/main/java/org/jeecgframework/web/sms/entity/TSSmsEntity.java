...
public class TSSmsEntity implements java.io.Serializable {
	...
	/**接收人Id*/
	@Excel(name="接收人Id")
	private java.lang.String esReceiverUserId;
	...
	@Column(name ="ES_RECEIVER_USERID",nullable=true,length=50)
	public java.lang.String getEsReceiverUserId() {
		return esReceiverUserId;
	}

	public void setEsReceiverUserId(java.lang.String esReceiverUserId) {
		this.esReceiverUserId = esReceiverUserId;
	}
