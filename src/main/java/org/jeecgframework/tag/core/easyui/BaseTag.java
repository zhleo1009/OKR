...
//            update-end--Author:zhangguoming  Date:20140521 for：云桌面图标拖拽、用户自定义桌面
			...
			if (oConvertUtils.isIn("easyui", types)) {
				...
				sb.append("<script type=\"text/javascript\" src=\"plug-in/easyui_1.4.4/jquery.easyui.min.js\"></script>");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/easyui_1.4.4/locale/easyui-lang-zh_CN.js\"></script>");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/tools/syUtil.js\"></script>");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/easyui_1.4.4/extends/datagrid-scrollview.js\"></script>");
				sb.append("<link rel=\"stylesheet\" href=\"plug-in/easyui_1.4.4/themes/bootstrap/lq.fieldset.css\">");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/easyui_1.4.4/extends/lq.fieldset.js\"></script>");
