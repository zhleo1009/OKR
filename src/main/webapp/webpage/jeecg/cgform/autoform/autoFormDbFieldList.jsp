...
<table border="0" cellpadding="2" cellspacing="2" id="autoFormDbField_table">
	<tr bgcolor="#E6E6E6">
		...
		<td align="center" width="40px" bgcolor="#EEEEEE">选择</td>
	  	<td align="center" width="140px" bgcolor="#EEEEEE"><t:mutiLang langKey="form.field.name"/></td>
		<td align="center" width="140px" bgcolor="#EEEEEE"><t:mutiLang langKey="form.field.content"/></td>
	  	<td align="center" width="60px" bgcolor="#EEEEEE"><t:mutiLang langKey="common.operation"/></td>
	</tr>
