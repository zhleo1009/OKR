...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="lte" action="generateController.do?dogenerate">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value"><input type="text" class="inputxt" value="${projectPath }" name="projectPath" id="projectPath" datatype="*" style="width: 300px;"/> <a href="#" id="openFoldSelect" class="easyui-linkbutton"
