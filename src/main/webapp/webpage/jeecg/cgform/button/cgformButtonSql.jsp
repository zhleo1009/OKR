...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="cgformButtonSqlController.do?save" tiptype="lte">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" width="90%" ><select id="buttonCode" name="buttonCode" datatype="*">
		...
		<tr>
			...
			<td class="value"><textarea id="content" name="content" style="width: 100%" rows="3">${cgformButtonSqlPage.content}</textarea> <span class="Validform_checktip"></span></td>
		</tr>
		<tr>
			<td align="right"><label class="Validform_label"> <t:mutiLang langKey="enhance.sql"/>: </label></td>
			<td class="value"><textarea id="cgbSqlStr" name="cgbSqlStr"  style="width: 100%" rows="25">${cgformButtonSqlPage.cgbSqlStr }</textarea> <span class="Validform_checktip"></span></td>
		</tr>
	</table>
</t:formvalid>
</body>
