...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="cgformEnhanceJavaController.do?save" tiptype="lte">
	...
	<table style="width: 100%" cellpadding="0" cellspacing="1" class="formtable"> 	
		<tr>
			<td align="right" width="25%" nowrap><label class="Validform_label"> <t:mutiLang langKey="operate.code"/>: </label></td>
			<td class="value" width="85%"><select id="buttonCode" name="buttonCode" datatype="*">
		...
		<tr>
			...
			<td class="value"><input id="cgJavaValue" name="cgJavaValue"  class="inputxt" value="${cgformEnhanceJavaPage.cgJavaValue}"/><span class="Validform_checktip"></span></td>
			<!--update-end--Author:luobaoli  Date:20150701 for：取消非空校验-->
		</tr>
	</table>
</t:formvalid>
