...
<t:datagrid name="roleUserList" title="common.operation" checkbox="true"
	...
	<t:dgDelOpt title="common.remove" url="roleController.do?delUserFromRole&roleid=${roleId}&ids={id}" />
	...
	<t:dgToolBar title="common.add.user" icon="icon-add" url="roleController.do?goAddUserToRole&roleId=${roleId}" funname="add" width="500"></t:dgToolBar>
	<t:dgToolBar title="common.remove" langArg="common.user" icon="icon-remove" url="roleController.do?delUserFromRole&roleid=${roleId}" funname="deleteALLSelect"></t:dgToolBar>
</t:datagrid>
