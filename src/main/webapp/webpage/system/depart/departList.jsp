...
<div id="main_depart_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="departList" title="common.department.list"
            ...
            <t:dgFunOpt funname="delDepart(id)" title="common.delete"></t:dgFunOpt>
            <%-- <t:dgDelOpt url="departController.do?del&id={id}" title="common.delete"></t:dgDelOpt> --%><!-- 修改样式 by zbk -->
...
function delDepart(id){
	top.layer.confirm('<t:mutiLang langKey="confirm.delete.record"/>？', function(index){
		doSubmit("departController.do?del&id=" + id,"departList");
