...
<div id="main_typegroup_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="typeGridTree" title="common.data.dictionary" actionUrl="systemController.do?typeGroupGrid"
            ...
            <t:dgToolBar title="common.add.param" langArg="lang.dictionary.type" icon="icon-add" url="systemController.do?aouTypeGroup" funname="add" height="150" width="550"></t:dgToolBar>
            <t:dgToolBar title="common.edit" icon="icon-edit" url="systemController.do?aouTypeGroup" funname="update" height="150" width="550"></t:dgToolBar>
        </t:datagrid>
    </div>
</div>
