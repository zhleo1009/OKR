...
//       update-start--Author:zhangguoming  Date:20140826 for：将combobox修改为combotree
		...
		function openDepartmentSelect() {
			$.dialog({content: 'url:departController.do?departSelect', zIndex: getzIndex(), title: '组织机构列表', lock: true, width: '400px', height: '350px', opacity: 0.4, min:false,  button: [
...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userController.do?saveUser" beforeSubmit="setOrgIds">
	...
	<table style="width: 100%" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" width="85%">
               <input id="userNo" class="inputxt" name="userNo" validType="t_s_user,user_no" value="" datatype="s2-20" />
                    <span class="Validform_checktip"> <t:mutiLang langKey="username.rang2to20"/></span>
            </td>
		</tr>
		-->
		<tr>
			...
			<td class="value" width="10%">
                <input id="realName" class="inputxt" name="realName" value="${user.realName }" datatype="s2-20">
		...
		<tr>
			...
			<td class="value">
                <input class="inputxt" name="officePhone" value="${user.officePhone}" ignore="ignore">
                <span class="Validform_checktip"></span>
            </td>
		</tr>
		<tr>
