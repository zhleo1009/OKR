...
<div class="easyui-layout" style="width:100%;height:450px;margin-top: 8px;">
    <div data-options="region:'west',split:true" title="<t:mutiLang langKey='common.department'/>">
    ...
    <div data-options="region:'center'" style="padding:0px;border:0px">
        <t:datagrid name="userList1" title="common.user.select" actionUrl="userController.do?datagrid"
            ...
            <t:dgCol title="common.peUserId" field="peUserId" hidden="true"></t:dgCol>
            <t:dgCol title="common.username" sortable="false" field="userName" query="true"></t:dgCol>
            <t:dgCol title="common.department" hidden="true" sortable="false" field="userOrgList.tsDepart.id" query="false"></t:dgCol>
