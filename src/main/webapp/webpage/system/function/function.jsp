...
<t:formvalid formid="formobj" layout="table" dialog="true" refresh="true" action="functionController.do?saveFunction">
	...
	<table style="width: 100%" cellpadding="0" cellspacing="1" class="formtable">
	    ...
	    <tr id="funurl">
			<td align="right" width="25%" nowrap>
                <label class="Validform_label"> <t:mutiLang langKey="menu.url"/>: </label>
            </td>
			<td class="value" width="85%">
               <input name="functionUrl" class="inputxt" value="${function.functionUrl}" style="width: 80%;">
            </td>
		</tr>
		...
		<tr id="funorder">
			<td align="right" width="25%" nowrap>
                <label class="Validform_label"> <t:mutiLang langKey="menu.order"/>: </label>
            </td>
			<td class="value" width="85%">
               <input name="functionOrder" class="inputxt" value="${function.functionOrder}" datatype="n1-3">
            </td>
		</tr>
	</table>
