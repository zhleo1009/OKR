...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="bbsCommentController.do?doAdd" tiptype="4" >
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value" nowrap>
					     	 <input id="commentUserid" name="commentUserid" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" nowrap>
					     	 <input id="postId" name="postId" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" nowrap>
					     	 <input id="quotesId" name="quotesId" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
