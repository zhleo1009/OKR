...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="bbsPostController.do?doAdd" tiptype="4" >
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value" nowrap>
					     	 <input id="postUserid" name="postUserid" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" nowrap>
					     	 <input id="editionId" name="editionId" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
