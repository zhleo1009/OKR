...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="bbsEditionController.do?doUpdate" tiptype="4" >
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value" nowrap>
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt" datatype="*" value='${bbsEditionPage.name}'>
					...
					<tr>
						...
						<td class="value" nowrap>
						  	 	<textarea id="intro" style="width:600px;" class="inputxt" rows="6" name="intro">${bbsEditionPage.intro}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value" nowrap>
						     	 <input id="logo" name="logo" type="text" style="width: 150px" class="inputxt"  value='${bbsEditionPage.logo}'>
							<span class="Validform_checktip"></span>
