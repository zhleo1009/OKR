...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userInfoController.do?doAdd" tiptype="lte" >
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value" nowrap>
					     	 <input id="university" name="university" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" nowrap>
					     	 <input id="origin" name="origin" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" nowrap>
					     	 <input id="height" name="height" type="text" style="width: 150px;line-height:24px;height:28px;" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" nowrap>
					     	 <input id="weight" name="weight" type="text" style="width: 150px;line-height:24px;height:28px;" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" nowrap>
						  	 <textarea style="width:600px;" class="inputxt" rows="6" id="introduction" name="introduction"></textarea>
							<span class="Validform_checktip"></span>
