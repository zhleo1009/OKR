...
<html>
 <head>
  <title>用户上传头像</title>
	<script src="jquery-html5-upload/jquery-1.10.2.js"></script>
	<link href="jquery-html5-upload/bootstrap/css/bootstrap.min.css" rel="stylesheet">
	...
	<script src="jquery-html5-upload/bootstrap/js/bootstrap.min.js"></script>
