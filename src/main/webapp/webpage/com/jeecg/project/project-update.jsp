 ...
 <body>
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="projectName" name="projectName" type="text" datatype="*" style="width: 150px" class="inputxt"  value='${projectPage.projectName}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="startDate" name="startDate" type="text" style="width: 150px" datatype="*"
				class="Wdate" onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'endDate\')||\'2020-10-01\'}',dateFmt:'yyyy-MM-dd HH:mm:ss'})"
				value="<fmt:formatDate value='${projectPage.startDate}' type="date" pattern="yyyy-MM-dd HH:mm:ss"/>">
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 value="<fmt:formatDate value='${projectPage.endDate}' type="date" pattern="yyyy-MM-dd HH:mm:ss"/>">
							<span class="Validform_checktip"></span>
				...
				class="inputxt"  onfocus="openDepartmentSelect()">
                <input id="org" name="org" type="hidden"  value='${projectPage.org}' >
                ...
                id="departRedo" onclick="callbackClean()">清空</a>
					...
					<tr>
						...
						<td class="value">
						<textarea style="width:300px; height: 30px" class="inputxt" id="remark" name="remark"  >${projectPage.remark}</textarea>
							<span class="Validform_checktip"></span>
