 ...
 <body>
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<textarea  id="objective" name="objective"  style="width: 250px;height: 30px" class="inputxt">${scOkrPage.objective}</textarea>
					...
					<tr>
						...
						<td class="value" nowrap>
							<textarea  id="keyResult" name="keyResult"  style="width: 250px;height: 30px" class="inputxt">${scOkrPage.keyResult}</textarea>	
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value" nowrap>
						<textarea  id="mission" name="mission"  style="width: 250px;height: 30px" class="inputxt">${scOkrPage.mission}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value" nowrap>
						     <input id="percent" name="percent"  style="width: 150px"
					     	  ...
					     	  class="inputxt" value='${scOkrPage.percent}' >
							<span class="Validform_checktip"></span>
