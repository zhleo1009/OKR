...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="scOkrController.do?doAdd" tiptype="4" >
					...
					<input id="updateDate" name="updateDate" type="hidden" value="${scOkrPage.updateDate }">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<textarea  id="objective" name="objective"  style="width: 250px;height: 30px" class="inputxt" datatype="*"></textarea>
				...
				<tr>
					...
					<td class="value" nowrap>
						<textarea  id="keyResult" name="keyResult"  style="width: 250px;height: 30px" class="inputxt" datatype="*"></textarea>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" nowrap>
					<textarea  id="mission" name="mission"  style="width: 250px;height: 30px" class="inputxt" datatype="*"></textarea>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" nowrap>
							...
							class="Wdate" 
		onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'finishTime\')||\'2020-10-01\'}'})" 
							datatype="*" >
							<span class="Validform_checktip"></span>
				...
				<tr><td colspan="2" style="text-align: center;"><span style="color: red;">以上OKR考核完成后,再填写以下表格</span></td></tr>
				<tr>
					<td align="right"  width="25%"  nowrap>
					...
					<td class="value" nowrap>
					<textarea  id="difficulties" name="difficulties"  style="width: 250px;height: 30px" class="inputxt"></textarea>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" nowrap>
					<textarea  id="unfinishedReason" name="unfinishedReason"  style="width: 250px;height: 30px" class="inputxt"></textarea>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" nowrap>
					     	 <input id="finishTime" name="finishTime" type="text" style="width: 150px"
					     	  class="Wdate" 
		 onFocus=" WdatePicker({minDate:'#F{$dp.$D(\'planTime\')||\'2020-10-01\'}'})" >
							<span class="Validform_checktip"></span>
