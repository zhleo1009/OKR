...
<div class="easyui-layout" fit="true" >
  ...
  <t:datagrid name="scOkrList" checkbox="false" sortName="createDate" sortOrder="desc" fitColumns="false" title=" " actionUrl="scOkrController.do?datagridMy" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="人员"  field="userId"  dictionary="t_s_base_user,id,realname"  queryMode="single"  width="55"></t:dgCol>
