...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="scWorkingHoursList" checkbox="true" fitColumns="false" title="项目工时表" actionUrl="scWorkingHoursController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="工时"  field="workingHours"    queryMode="single"  width="60"></t:dgCol>
