   ...
   <div class="row  border-bottom white-bg dashboard-header">
        <div class="col-sm-12">
            <blockquote class="text-warning" style="font-size:14px">
             <h1>OKR管理系统使用手册</h1>
             <span >
  				<img alt="" src="webpage/main/img/zhuangtai.jpg" style="width:1600px;height: 400px">
  			</span>
  			 <br>
           	 <br>
        </div>
        <div class="col-sm-3">
       	 <h3>【第一步】打开我的OKR列表</h3>
             <span >
  				<img alt="" src="webpage/main/img/diyibu.jpg" style="width:710px;height: 387px">
  			</span>
  			<br>
           	 <br>
  			<h3>【第二步】新建OKR</h3>
             <span >
  				<img alt="" src="webpage/main/img/xinjian.jpg" style="width:815px;height: 545px">
  			</span>
  			<br>
           	 <br>
  			<h3>【第三步】填写完转交下一步</h3>
             <span >
  				<img alt="" src="webpage/main/img/tijiao1.jpg" style="width:815px;height: 545px">
  			</span>
  			<br>
           	 <br>
  			<h3>【第四步】填写完毕提交</h3>
             <span >
  				<img alt="" src="webpage/main/img/tijiao2.jpg" style="width:815px;height: 545px">
  			</span>
  			<br>
           	 <br>
  			<h3>【第五步】导出已填写的OKR</h3>
             <span >
  				<img alt="" src="webpage/main/img/daochu.jpg" style="width:710px;height: 390px">
  			</span>
